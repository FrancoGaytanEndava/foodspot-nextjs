  ...
  questions: [
    {
      ...
      answer:
        'En tu perfil, tenés un checkbox llamado: activar notificaciones. Si lo activás, se abrirán otros campos para ingresar el mail a donde las querés recibir y además podés elegir cuándo querés recibirlas.',
    },
    {
      question: '¿Cómo puedo recuperar mi contraseña?',
      answer:
        'Hacé clic en “¿Olvidaste tu contraseña?” en el login y seguí los pasos. Se te solicitará ingresar el mail con el cual te registraste y luego se te enviará un mail con un código, el cual será necesario para validar tu identidad y registrar tu nueva contraseña.',
    },
    {
      question: '¿Qué hacer si aparezco como deudor?',
      answer:
        'Si aparecés como deudor, el motivo es que no abonaste alguno de los eventos previos, o que el encargado de compras de ese evento no ha aprobado tu pago. Asegurate de tener cubiertas esas dos posibilidades, luego podrás inscribirte sin problemas a otro evento.',
    },
    {
      question: '¿Qué es y cómo funciona un evento privado?',
      answer:
        'Un evento privado es aquel al cual solo pueden unirse las personas que reciban una invitación directa o tengan el link de acceso. Estos eventos no son visibles en la lista de eventos públicos, por lo cual no lo podrás ver a menos que accedas directamente a este y te inscribas. Para crear un evento privado, debés seleccionar la opción de "Evento privado" al momento de crear el evento y luego invitar a los participantes compartiendo el enlace del evento.',
    },
    {
