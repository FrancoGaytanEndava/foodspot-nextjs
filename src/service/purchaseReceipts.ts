...
import {
  IPurchaseReceiptRequest,
  IPurchaseByEvent,
  IPurchaseReceipt,
  IPurchaseAssignmentResponse,
...
export async function createPurchaseReceipt(
  idEvent: string,
  payload: IPurchaseReceiptRequest,
  signal?: AbortSignal
