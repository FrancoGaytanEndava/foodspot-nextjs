import {
  ITransferReceiptRequest,
  ITransferReceiptImage,
  ITransferReceiptResponse,
  IUploadFileResponse,
...
export async function uploadFile(
  formFile: ITransferReceiptImage,
...
export async function deleteTransferReceipt(
  idTransferReceipt: string | undefined,
  signal?: AbortSignal
): Promise<ITransferReceiptResponse> {
...
export async function approvePaymentWithoutReceipt(
  idUser: string,
  idEvent: string,
  signal?: AbortSignal
): Promise<ITransferReceiptResponse> {
